var questoes = [
    ...
    },
    {
        ...
        alternativas: { A: "P(8) = 600 unidades; 12 dias.", B: "P(8) = 600 unidades; 10 dias.", C: "P(8) 400 unidades; 12 dias.", D: "P(8) 400 unidades; 8 dias." },
        correta: "A",
...
var TOTAL_QUESTOES_DESEJADAS = 34;
var Q_FAKE_COUNT = TOTAL_QUESTOES_DESEJADAS - questoes.length;

for (var i = 0; i < Q_FAKE_COUNT; i++) {
    var fakeId = questoes.length + 1;
    questoes.push({
        id: fakeId,
